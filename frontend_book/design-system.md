# Design System - Docusaurus UI

This document outlines the design system implemented for the Docusaurus UI design upgrade, including all design tokens and their usage.
